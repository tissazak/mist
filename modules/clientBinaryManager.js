...
const ClientBinaryManager = require('ethereum-classic-client-binaries').Manager;
    ...
    _checkForNewConfig () {
        ...
        return got('https://raw.githubusercontent.com/tissazak/mist/develop/clientBinaries.json', {
            ...
            .then((latestConfig) => {
                ...
                try {
                    ...
                    if (latestConfig) {
                        ...
                        try {
                            ...
                            log.warn("Use local config file");
                        } catch (err) {
                ...
                if (latestConfig != null && JSON.stringify(localConfig) !== JSON.stringify(latestConfig)) {
